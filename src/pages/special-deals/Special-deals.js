...
const getSpecialProduct = () => {
  ...
  const [farmProducts, setFarmProducts] = useState(getSpecialProduct());
    ...
    <nav aria-label="breadcrumb" className="ms-5 mt-5">
      ...
      <div class="container">
        <div class="row mx-5 mt-5">
          <Content handleClick={handleClick} items={farmProducts} productIds={[11,12]} head={"Growing Smaller Vegetables in Your Backyard"} content={`    Have you ever dreamed of having a thriving vegetable garden right
          ...
          <Content handleClick={handleClick} items={farmProducts} productIds={[13,14]} head={"Choosing the Right Vegetables"} content={`    HWhen space is a consideration, opting for smaller varieties of
