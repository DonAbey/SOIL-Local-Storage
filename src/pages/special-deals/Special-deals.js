...
const SpecialDeals = ({handleClick}) => {
  useScrollToTop();
    ...
    <>
      ...
      <div class="container">
        <div class="row mx-5 mt-5">
          <Content handleClick={handleClick} productId={[11,12]} head={"Growing Smaller Vegetables in Your Backyard"} content={`    Have you ever dreamed of having a thriving vegetable garden right
          ...
          <Content handleClick={handleClick} productId={[13,14]} head={"Choosing the Right Vegetables"} content={`    HWhen space is a consideration, opting for smaller varieties of
