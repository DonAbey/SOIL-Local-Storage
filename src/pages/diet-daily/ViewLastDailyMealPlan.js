            ...
            <div className="row">
                <div className="col">
                    <ul className="list-group mb-4">
                        ...
                        <li className="list-group-item">Total Calories: {lastMealPlan.nutrients.calories}</li>
                        <li className="list-group-item">Total Carbohydrates: {lastMealPlan.nutrients.carbohydrates}g</li>
                        <li className="list-group-item">Total Fat: {lastMealPlan.nutrients.fat}g</li>
                        <li className="list-group-item">Total Protein: {lastMealPlan.nutrients.protein}g</li>
                    </ul>
                </div>
            </div>
                    ...
                    <div key={index} className="col-md-4 mb-4">
                        <div className="card h-100">
                            ...
                            <div className="card-footer">
                                <a href={meal.sourceUrl} className="btn btn-primary" target="_blank" rel="noopener noreferrer">Go to Recipe</a>
                            </div>
                        </div>
                    </div>
                ))}
