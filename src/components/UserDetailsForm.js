                ...
                <div className="mb-3">
                    <label className="form-label me-3">Activity Level</label>
                        <div className="btn-group" 
                            ...
                            <input type="button" 
                                key={level} 
                                className={`btn ${activityLevel === level ? 'btn-primary' : 'btn-outline-primary'}`} 
                                value={level} 
                        ...
                        {errors.activityLevel && <div className="text-danger">{errors.activityLevel}</div>}
                </div>
                ...
                <div className="mb-3">
                    <label className="form-label me-4">Health Goal</label>
                        <div className="btn-group" role="group" aria-label="Health goal">
                            ...
                            <input type="button" 
                                key={goal} 
                                className={`btn ${healthGoal === goal ? 'btn-success' : 'btn-outline-success'}`} 
                                value={goal} 
                        ...
                        {errors.healthGoal && <div className="text-danger">{errors.healthGoal}</div>}
                </div>
